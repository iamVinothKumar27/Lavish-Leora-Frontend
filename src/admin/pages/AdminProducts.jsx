                  ...
                  <tr key={p._id} className="hover:bg-gray-50/60 transition-colors">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-3">
                        <div className="relative w-12 h-12 rounded-xl overflow-hidden bg-beige flex-shrink-0 group/thumb">
                          <img
                          ...
                          <button
                            ...
                            onClick={() => downloadImage(getProductImageUrl(p), p.name)}
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">{p.categoryPath || p.subcategory || p.category}</p>
                        </div>
                      </div>
                    </td>
                    <td className="py-3 px-4">
